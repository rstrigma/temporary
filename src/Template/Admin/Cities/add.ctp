                    ...
                    <div class="col-lg-11">
							...
							<?php echo $this->Form->create($getCity, array('type'=>'file')); ?>
								...
								<div class="form-group">
										...
										<?php echo $this->Form->input('seo_content', array('type'=>'textarea',  'required'=>false, 'label'=>false, 'div'=>false, 'id'=>'seo_content', 'class'=>'form-control pagecontent', 'style'=>array('height:200px;width:928px;'))); ?>										
										</div>						
								</div>
